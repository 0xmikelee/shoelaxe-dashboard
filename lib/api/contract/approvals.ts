...
export const getApprovalStatsDoc = {
...
export const approvalsLiveContract: RouteDoc[] = [listApprovalsDoc, getApprovalStatsDoc];

/** All Screen 1 reads have landed. */
