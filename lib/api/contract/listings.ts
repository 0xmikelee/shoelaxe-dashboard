...
export const getListingHistoryDoc = {
...
export const updateListingMarginsDoc = {
...
export const setListingPriceDoc = {
...
export const approveListingDoc = {
...
export const deactivateListingDoc = {
...
export const reactivateListingDoc = {
...
export const bulkApproveListingsDoc = {
...
/** Landed: approve / reject / price / bulk-approve. */
export const listingsLiveContract: RouteDoc[] = [
  setListingPriceDoc,
  approveListingDoc,
  rejectListingDoc,
  bulkApproveListingsDoc,
];

/** Still MSW-only: detail, history, margins, deactivate/reactivate. */
export const listingsContract: RouteDoc[] = [
  getListingDoc,
  getListingHistoryDoc,
  updateListingMarginsDoc,
  deactivateListingDoc,
  reactivateListingDoc,
];
