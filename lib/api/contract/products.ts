...
export const exportProductsDoc = {
...
export const updateProductMarginsDoc = {
...
export const getProductHistoryDoc = {
...
export const bulkUpdateProductsDoc = {
...
export const uploadProductImageDoc = {
...
export const updateProductImageDoc = {
...
export const deleteProductImageDoc = {
...
export const reorderProductImagesDoc = {
...
export const productsLiveContract: RouteDoc[] = [
  getProductDoc,
  updateProductDoc,
  uploadProductImageDoc,
  updateProductImageDoc,
  deleteProductImageDoc,
  reorderProductImagesDoc,
];

export const productsContract: RouteDoc[] = [
  listProductsDoc,
  exportProductsDoc,
  updateProductMarginsDoc,
  getProductHistoryDoc,
  bulkUpdateProductsDoc,
];
